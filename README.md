...
- **安全上限**:普通文本超过 5MB 只预览前 5MB 并禁用编辑;Office 文件最多读取 10 MiB,
  PDF/图片最多读取 20 MiB,Office 解析有 10 秒 watchdog,表格最多展示 1000 行、100 列和
  100,000 个单元格,生成 HTML 不超过 2 MiB;超过限制时提示下载完整文件
